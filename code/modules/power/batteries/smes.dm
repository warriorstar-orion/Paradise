...
/obj/machinery/power/battery/smes/proc/make_terminal(user, temporary_direction, temporary_location)
...
/obj/machinery/power/battery/smes/proc/charge_display()
...
/obj/machinery/power/battery/smes/ui_state(mob/user)
	return GLOB.default_state

/obj/machinery/power/battery/smes/ui_interact(mob/user, datum/tgui/ui = null)
	if(stat & BROKEN)
		return
