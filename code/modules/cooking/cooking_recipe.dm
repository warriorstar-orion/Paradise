...
// 				#endif
// 				continue
// 			if(GLOB.pcwj_step_dictionary_ordered["[PCWJ_ADD_ITEM]"] && GLOB.pcwj_step_dictionary_ordered["[PCWJ_ADD_ITEM]"][id])
// 				var/datum/cooking/recipe_step/add_item/active_step = GLOB.pcwj_step_dictionary_ordered["[PCWJ_ADD_ITEM]"][id]
...
// 					exclude_list += id
// 					break
// 			else if(GLOB.pcwj_step_dictionary_ordered["[PCWJ_ADD_PRODUCE]"] && GLOB.pcwj_step_dictionary_ordered["[PCWJ_ADD_PRODUCE]"][id])
// 				var/datum/cooking/recipe_step/add_produce/active_step = GLOB.pcwj_step_dictionary_ordered["[PCWJ_ADD_PRODUCE]"][id]
// 				exclude_specific_reagents = active_step.exclude_reagents
// 				if(active_step.reagent_skip)
// 					#ifdef PCWJ_DEBUG
// 					log_debug("/recipe/proc/create_product: Reagent skip detected. Ignoring reagents from [added_item].")
