...
/obj/item/food/dollop/New(var/loc, var/new_reagent_id = "frosting", var/new_amount = 30)
	. = ..()
	if(new_reagent_id)
...
/obj/item/food/dollop/Initialize()
	. = ..()
	update_icon()

/obj/item/food/dollop/update_icon()
