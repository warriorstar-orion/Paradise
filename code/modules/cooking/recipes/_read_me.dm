...
<CWJ_STEP_CLASS>
	...
	Valid options are:
		CWJ_ADD_ITEM
			...
			Example: list(CWJ_ADD_ITEM, /obj/item/food/breadslice)
...
<_OPTIONAL>
	...
	Example: list(CWJ_ADD_ITEM_OPTIONAL, /obj/item/food/breadslice)
...
<CUSTOM_ARGS>
	...
	Example: list(CWJ_ADD_ITEM, /obj/item/food/breadslice, desc="a custom description")
