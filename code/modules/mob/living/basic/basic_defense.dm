/mob/living/basic/attack_hand(mob/living/carbon/human/M)
	...
	switch(M.a_intent)
		...
		if(INTENT_HELP)
			if(health > 0)
				visible_message("<span class='notice'>[M] [response_help_continuous] [src].</span>", "<span class='notice'>[M] [response_help_continuous] you.</span>")
		...
		if(INTENT_HARM, INTENT_DISARM)
			...
			visible_message("<span class='danger'>[M] [response_harm_continuous] [src]!</span>", "<span class='userdanger'>[M] [response_harm_continuous] you!</span>")
...
/mob/living/basic/attack_hulk(mob/living/carbon/human/user, does_attack_animation = FALSE)
...
/mob/living/basic/bullet_act(obj/item/projectile/Proj)
	if(!Proj)
		return
...
/mob/living/basic/ex_act(severity, origin)
