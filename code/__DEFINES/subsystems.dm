...
#define INIT_ORDER_SPATIAL_GRID 14
#define INIT_ORDER_ATOMS 13
#define INIT_ORDER_MACHINES 12
#define INIT_ORDER_HOLIDAY 11
#define INIT_ORDER_IDLENPCS 10
#define INIT_ORDER_MOBS 9
