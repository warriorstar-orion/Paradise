/datum/ai_planning_subtree/carbon_melee_attack_subtree
	...
	var/datum/ai_behavior/carbon_melee_attack/melee_attack_behavior = /datum/ai_behavior/carbon_melee_attack
	/// Is this the last thing we do? (if we set a movement target, this will usually be yes)
	var/end_planning = TRUE

/datum/ai_planning_subtree/carbon_melee_attack_subtree/select_behaviors(datum/ai_controller/controller, seconds_per_tick)
	. = ..()
