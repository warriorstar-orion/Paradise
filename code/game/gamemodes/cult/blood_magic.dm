...
/datum/action/innate/cult/blood_spell/apply_button_overlay(atom/movable/screen/movable/action_button/current_button, force)
	. = ..()
	...
	current_button.add_overlay(count_down_holder)
