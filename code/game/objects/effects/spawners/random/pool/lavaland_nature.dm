GLOBAL_DATUM_INIT(lavaland_spawn_pool_manager, /datum/spawn_pool_manager/lavaland, new)
...
/obj/effect/spawner/random/pool/lavaland/Initialize(mapload)
	spawn_pool_manager = GLOB.lavaland_spawn_pool_manager
	return ..()
...
/obj/effect/spawner/random/pool/lavaland/flora
	point_value = 1
	loot = list(
...
/obj/effect/spawner/random/pool/lavaland/combined
	loot = list(
		/obj/effect/spawner/random/pool/lavaland/flora = 4,
